 ...
 *
 */
$drupal_hash_salt = 'I98LqPIFQUoXCm-v1v6WuaEPNMUDVhS7mqVhOWjhU28';
...
/*
 * Include a local file with environmnet specific settings like the database
 * connection information.
 */
if (file_exists('../settings.studioone.php')) {
  require('../settings.studioone.php');
}
